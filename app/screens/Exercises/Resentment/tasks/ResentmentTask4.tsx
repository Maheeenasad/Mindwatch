...
export default function ResentmentTask4Screen() {
  const navigation = useNavigation<NavigationProp>();

  const handleCompleteTask = () => {
    navigation.replace("Resentment", { taskCompleted: true, taskScreen: "ResentmentTask4" });
  };

  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Image source={require("@/assets/exercises/ResentmentTask4.jpg")} style={styles.image} />
