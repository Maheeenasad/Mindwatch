...
export default function ResentmentTask2Screen() {
  const navigation = useNavigation<NavigationProp>();

  const handleCompleteTask = () => {
    navigation.replace("Resentment", { taskCompleted: true, taskScreen: "ResentmentTask2" });
  };

  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Image source={require("@/assets/exercises/ResentmentTask2.jpg")} style={styles.image} />
