...
export default function ResentmentTask1Screen() {
  const navigation = useNavigation<NavigationProp>();

  const handleCompleteTask = () => {
    navigation.replace("Resentment", { taskCompleted: true, taskScreen: "ResentmentTask1" });
  };

  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Image source={require("@/assets/exercises/Resentment.jpg")} style={styles.image} />
