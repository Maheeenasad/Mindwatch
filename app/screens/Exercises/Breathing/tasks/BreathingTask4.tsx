        ...
        <View style={styles.content}>
          ...
          <View style={styles.stepsContainer}>
            <Text style={styles.description}>
              Shape Breathing is a creative technique that helps children focus and calm their minds by associating breath control with tracing geometric shapes. This method enhances concentration and
              provides a fun way to practice mindful breathing.
            </Text>
            ...
            <Text style={styles.stepText}>
              Incorporating Shape Breathing into daily routines offers children a playful yet effective tool to manage stress and enhance mindfulness. Encouraging regular practice can lead to improved
