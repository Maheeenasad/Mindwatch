        ...
        <View style={styles.content}>
          ...
          <View style={styles.stepsContainer}>
            <Text style={styles.description}>
              Animal Breaths are engaging and imaginative breathing exercises that help children manage stress and anxiety by mimicking the breathing patterns of various animals. This playful approach
