...
type SadnessScreenProps = NativeStackScreenProps<RootStackParamList, "Sadness"> & {
  route: {
    params: {
...
export default function SadnessScreen() {
  ...
  const navigation = useNavigation<SadnessScreenProps["navigation"]>();
  const route = useRoute<SadnessScreenProps["route"]>(); 
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.taskList}>
        {tasks.map((task, index) => (
          ...
          >
            <Image source={require("@/assets/exercises/sadness.png")} style={styles.taskImage} />
