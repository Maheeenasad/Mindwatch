...
export default function ShameTask2Screen() {
  const navigation = useNavigation<NavigationProp>();

  const handleCompleteTask = () => {
    navigation.replace("Shame", { taskCompleted: true, taskScreen: "ShameTask2" });
  };

  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Image source={require("@/assets/exercises/ShameTask2.jpg")} style={styles.image} />
