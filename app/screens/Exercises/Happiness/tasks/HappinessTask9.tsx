        ...
        <View style={styles.content}>
          ...
          <View style={styles.stepsContainer}>
            ...
            <Text style={styles.stepText}>
              - <Text style={{ fontWeight: 'bold' }}>Duration:</Text> 3 minutes{'\n'}- <Text style={{ fontWeight: 'bold' }}>Activity:</Text> Begin by clapping your hands rhythmically while chanting
              "Ho Ho Ha Ha Ha." This simple exercise warms up your body and sets a joyful tone for the session.
            </Text>

            <Text style={styles.stepTitle}>😂 Step 2: Engage in Laughter Exercises</Text>
            <Text style={styles.stepText}>
              - <Text style={{ fontWeight: 'bold' }}>Duration:</Text> 10 minutes{'\n'}- <Text style={{ fontWeight: 'bold' }}>Activity:</Text> Participate in various laughter exercises, such as: -
              **Lion Laughter**: Stick out your tongue, widen your eyes, and stretch your hands out like claws while laughing. This exercise helps release tension and boosts energy.**Belly Laughter**:
              Place your hands on your abdomen and laugh deeply, engaging your diaphragm. This promotes relaxation and massages internal organs. - **Silent Laughter**: Open your mouth wide and laugh
              without making a sound. This can be a fun challenge and enhances focus.
            </Text>

            <Text style={styles.stepTitle}>🧘 Step 3: Cool Down with Deep Breathing</Text>
            <Text style={styles.stepText}>
              - <Text style={{ fontWeight: 'bold' }}>Duration:</Text> 2 minutes{'\n'}- <Text style={{ fontWeight: 'bold' }}>Activity:</Text> Conclude your session with deep breathing exercises. Inhale
              deeply through your nose, hold for a moment, and exhale slowly through your mouth. This helps calm the mind and body.
            </Text>
