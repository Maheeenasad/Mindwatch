...
export default function SocialAnxietyTask5Screen() {
  const navigation = useNavigation<NavigationProp>();

  const handleCompleteTask = () => {
    navigation.replace("SocialAnxiety", { taskCompleted: true, taskScreen: "SocialAnxietyTask5" });
  };

  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Image source={require("@/assets/exercises/SocialAnxietyTask5.jpg")} style={styles.image} />
