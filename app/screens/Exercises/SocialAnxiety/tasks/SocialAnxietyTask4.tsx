...
export default function SocialAnxietyTask4Screen() {
  const navigation = useNavigation<NavigationProp>();

  const handleCompleteTask = () => {
    navigation.replace("SocialAnxiety", { taskCompleted: true, taskScreen: "SocialAnxietyTask4" });
  };

  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Image source={require("@/assets/exercises/SocialAnxietyTask4.jpg")} style={styles.image} />
        <View style={styles.content}>
          ...
          <View style={styles.stepsContainer}>
            <Text style={styles.stepTitle}>😰 Step 1: Identify Triggers</Text>
            ...
            <Text style={styles.stepTitle}>🌟 Step 3: Exposure Practice</Text>
            <Text style={styles.stepText}>
