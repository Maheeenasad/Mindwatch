...
export default function SocialAnxietyTask3Screen() {
  const navigation = useNavigation<NavigationProp>();

  const handleCompleteTask = () => {
    navigation.replace("SocialAnxiety", { taskCompleted: true, taskScreen: "SocialAnxietyTask3" });
  };

  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Image source={require("@/assets/exercises/SocialAnxietyTask3.jpg")} style={styles.image} />
