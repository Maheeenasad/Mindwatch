...
type SocialAnxietyScreenProps = NativeStackScreenProps<RootStackParamList, "SocialAnxiety"> & {
  route: {
    params: {
...
export default function SocialAnxietyScreen() {
  ...
  const navigation = useNavigation<SocialAnxietyScreenProps["navigation"]>();
  const route = useRoute<SocialAnxietyScreenProps["route"]>(); 
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.taskList}>
        {tasks.map((task, index) => (
          ...
          >
            <Image source={require("@/assets/exercises/socialanxeity.png")} style={styles.taskImage} />
