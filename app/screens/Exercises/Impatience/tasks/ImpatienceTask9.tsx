...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'ImpatienceTask9'>;

export default function ImpatienceTask9Screen() {
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.content}>
          <Text style={styles.title}>Timed Journaling</Text>
          ...
          <View style={styles.stepsContainer}>
            <Text style={styles.description}>
              Timed journaling is an effective method to enhance self-awareness, manage emotions, and cultivate patience. This exercise guides you through a structured journaling session to reflect on
            ...
            <Text style={styles.stepText}>
              Regular timed journaling can help you process emotions, identify areas for personal growth, and develop greater patience. By dedicating time to self-reflection, you enhance your ability
          ...
          <View style={styles.videoContainer}>
            <WebView source={{ uri: 'https://www.youtube.com/embed/Ztek9ZhZo9E' }} style={styles.video} allowsFullscreenVideo={true} javaScriptEnabled={true} domStorageEnabled={true} />
          </View>
