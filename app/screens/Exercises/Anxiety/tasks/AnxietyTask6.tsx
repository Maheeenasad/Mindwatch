        ...
        <View style={styles.content}>
          ...
          <View style={styles.stepsContainer}>
            <Text style={styles.description}>
              Mindful walking is a practice that combines the physical benefits of walking with mindfulness techniques to help reduce anxiety and improve overall well-being. By focusing on the present
              moment and your surroundings, you can cultivate a sense of calm and clarity. Follow the steps below to engage in a mindful walking exercise.
            </Text>
            ...
            <Text style={styles.stepText}>
              ...
              {'\n'}- <Text style={{ fontWeight: 'bold' }}>Sight:</Text> Observe the colors, shapes, and movements around you.{'\n'}- <Text style={{ fontWeight: 'bold' }}>Sound:</Text> Listen to the
              sounds in your environment, whether it's birds chirping, leaves rustling, or distant traffic.{'\n'}- <Text style={{ fontWeight: 'bold' }}>Smell:</Text> Notice any scents in the air, like
              fresh grass or blooming flowers.{'\n'}- <Text style={{ fontWeight: 'bold' }}>Touch:</Text> Feel the texture of the ground beneath your feet and the sensation of the air on your skin.
            </Text>
            ...
            <Text style={styles.stepText}>
              Incorporating mindful walking into your routine can be a valuable tool for managing anxiety. It encourages you to connect with the present moment and fosters a sense of peace and
              relaxation.
            </Text>
          </View>
